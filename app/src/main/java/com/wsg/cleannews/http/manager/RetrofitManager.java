package com.wsg.cleannews.http.manager;
...
import com.wsg.cleannews.http.service.NewsService;
import com.wsg.cleannews.utils.NetUtil;
...
public class RetrofitManager {
        ...
        if (mOkHttpClient == null) {
            ...
            synchronized (RetrofitManager.class) {
                ...
                if (mOkHttpClient == null) {
                    ...
                    // 指定缓存路径,缓存大小100Mb
                    Cache cache = new Cache(new File(CleanNewsApplication.getContext().getCacheDir(), "HttpCache"),
                            1024 * 1024 * 100);
    ...
    private Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetUtil.isConnected(CleanNewsApplication.getContext())) {
    ...
    private String getCacheControl() {
        return NetUtil.isConnected(CleanNewsApplication.getContext()) ? CACHE_CONTROL_NETWORK : CACHE_CONTROL_CACHE;
    }
    ...
    public Observable<Map<String, List<NeteastNewsSummary>>> getNewsListObservable(String type, String id, int startPage) {
        return mNewsService
                .getNewsList(getCacheControl(), type, id, startPage)
...
//        Logger.e("新浪图片新闻列表: " + photoTypeId + ";" + page);
